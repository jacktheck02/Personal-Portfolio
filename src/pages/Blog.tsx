...
const posts = [
  {
    ...
    date: 'Oct 24, 2023',
    summary: 'A brief introduction to reactive programming with SolidJS and why it might be the right choice for your next project.',
    tags: ['SolidJS', 'Frontend', 'Reactivity']
  }
];
...
const Blog: Component = () => {
  return (
    <div class="space-y-12">
      <div>
        <h1 class="text-4xl font-extrabold text-nord-6 mb-8 tracking-tight pb-4">Blog</h1>
        <p class="text-xl text-nord-4 leading-relaxed max-w-2xl mb-8">
          Thoughts on software engineering, UI design, and web development.
        </p>
      </div>
